...
PROJECT_SLUG = 'wh-press-briefings'

# Project name to be used in file paths
PROJECT_FILENAME = 'wh_press_briefings'

# The name of the repository containing the source
REPOSITORY_NAME = 'wh-press-briefings'
...
ASSETS_SLUG = 'wh-press-briefings'
...
DISQUS_UUID = '2dfe2585-8170-11e4-bc98-a820662c8a94'
